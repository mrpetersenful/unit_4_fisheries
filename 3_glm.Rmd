...
We have statistically significant, negative coefficients for the Mediterranean-Black Sea stocks and the West Africa stocks - meaning these stocks are less likely to collapse than the reference region, which is the Atlantic Ocean. The Canada East and West Coast stock groups are almost significant at $\alpha = 0.05$, and since those coefficients are positive that indicates that stocks are more likely to collapse than stocks in the Atlantic Ocean (the reference region). There are no examples of collapsed stocks in the Pacific Ocean and Indian Ocean regions.
