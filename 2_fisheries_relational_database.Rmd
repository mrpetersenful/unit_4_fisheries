...
ggplot() +
  geom_line(aes(x=tsyear, y=tsvalue, color=stockid), data=fish_catch) +
  theme(legend.position = "none") +
  ggsave('figures/total_catch_all_stocks.png', device="png", height=4, width=7, units="in")

# Fishery with heighest annual catch
glimpse( fish_catch %>% arrange(desc(tsvalue)) ) # what had the highest catch?
```
